...
export function ProposalCardWithApproval({ proposal, onEditProposal, onUpdateProposal }: ProposalCardWithApprovalProps) {
  ...
  // ⬇️ Sekarang hanya P1 & P2 (tanpa admin)
  const handleProtoApprove = (role: "supervisor1" | "supervisor2") => {
    ...
    if (role === "supervisor1") {
      ...
      toast.success("Pembimbing 1 menyetujui usulan");
      ...
      toast.success("Pembimbing 2 menyetujui usulan");
    }

    // Check if semua pembimbing sudah approve
    ...
    if (allApproved) {
      // Bedakan label status untuk tahap proposal vs final
      updates.status =
        ...
        {isExpanded && proposal.status === "Menunggu Persetujuan" && (
          <div className="border-t border-gray-200 bg-gray-50 p-6">
            ...
            <p className="text-sm text-gray-600 font-[Roboto] mb-4">
              Usulan topik/tugas akhir Anda memerlukan persetujuan dari Pembimbing 1 dan Pembimbing 2.
            </p>
            ...
            {/* 2 Column Approval Layout (P1 & P2 saja) */}
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-4">
              ...
              <p className="text-xs text-gray-600 font-[Roboto] mt-2">
                {approvalCount === 0 && "Menunggu persetujuan dari kedua pembimbing"}
                {approvalCount === 1 && "1 dari 2 pembimbing telah menyetujui"}
            ...
            >
              {proposal.isDraft ? "Edit Proposal" : "Lihat Detail Proposal"}
            </button>
          </div>
        )}
      </div>
